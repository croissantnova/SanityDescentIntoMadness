...
public class ModelSneakingTerror extends AnimatedGeoModel<SneakingTerror>
{
    ...
    @Override
    public ResourceLocation getModelResource(SneakingTerror object)
    {
        return MODEL_LOCATION;
    }

    @Override
    public ResourceLocation getTextureResource(SneakingTerror object)
    {
        return TEXTURE_LOCATION;
    }

    @Override
    public ResourceLocation getAnimationResource(SneakingTerror animatable)
    {
